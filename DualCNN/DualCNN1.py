...
from DATA.DataImport import import_datasets
...
class BinaryCNN:
    ...
    def __init__(self, batch_size, epochs):
        ...
        self.train_ds, self.val_ds = import_datasets(batch_size=batch_size)
...
TestNetwork = BinaryCNN(batch_size=24, epochs=100)